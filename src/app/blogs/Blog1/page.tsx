  ...
  return (
        <div className=' sm:w-screen w-screen flex flex-col '>
          ...
          <div className=' flex h-screen'>
            <div className='sm:pl-6 pl-3 sm:ml-2 ml-0 mr-0'></div>
          <div className=' w-1/6  h-screen'></div>
            ...
            <br />
              <div className=' text-orange-500 text-left font-bold  sm:text-4xl text-xl'>
                ...
                <br />
                <div className=' flex  '>
                  <div className=' sm:w-3/4 w-screen sm:text-xl text-xs h-300 border-4 text-blue-700 font-semibold overflow-wrap break-word  border-blue-700 p-3 mr-0 '>
                  ...
                  <div className='sm:flex-col flex-col ml-1 my-1'>
                  {/* ロリポップ　中 */}
                  <div className='sm:z-50 z-50 ml-50 hover:scale-105 active:scale-95'>
                  ...
                  {/* 365日記念日デコケーキ */}
                  <div className='sm:z-50 z-50 ml-50 over:scale-105 active:scale-95'>
                    <Link href={"https://px.a8.net/svt/ejp?a8mat=3HR8H2+5DHXXE+426S+699KH"} >
                      <a href="https://px.a8.net/svt/ejp?a8mat=3HR8H2+5DHXXE+426S+699KH" rel="nofollow" className='z-10 '>
                ...
                <br />
                <div className='flex sm:ml-7 sm:mr-0 my-0 py-0 '>
