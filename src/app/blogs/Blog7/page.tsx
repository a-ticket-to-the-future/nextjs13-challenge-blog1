          ...
          <div className=' w-1/6  h-screen'></div>
            ...
            <br />
              <div className=' text-orange-500 text-left font-bold  sm:text-4xl text-xl'>
                <p>特別な日に添える、あなただけの贈り物にいかがでしょうか？</p>
                ...
                <div className=' flex  '>
                  <div className=' w-3/4 sm:text-xl text-xs h-300 text-blue-700 font-semibold overflow-wrap break-word border-4 border-blue-700 p-5 '>
                    <br />
                    ドラマにも衣装協力していたりと、スタイリストさんからも注目のショップ！
                    <br />
                    <br />
                    丁寧な梱包とおしゃれなラッピングで、ギフトとして購入される方も多数！
                    <br />
                    <br />
                    平均的な購入単価は1万円前後!
                    <br />
                    <br />
                    <br />
                    大切な人との記念日やお誕生日、お祝い事や日頃の感謝、自分へのご褒美など、
                    特別な日に添える、あなただけの贈り物にいかがでしょうか？
                    <br />
                    <br />
                    リンクをチェックしてね♡
                    <br />
                    ...
                    <br />
                    <br />
                      1つ1つ、素材・デザインにこだわった商品を丁寧に作っていて、
                    <br />
                    ◆ブランドコンセプト◆
                    <br />
                     一緒に時を刻むジュエリー My Story,My Jewelry. どんな日にも寄り添うベーシックなジュエリーに、フェミニンな甘さをひとさじ。 
                     <br />
                     <br />
                     纏った瞬間から心がやわらぎ、動きや仕草までが美しくなる。 
                     <br />
                     <br />
                     そんな心ときめくマイジュエリーを。
                      ご褒美として ・お友達やご家族へのプレゼントに ・彼女・奥様へのプレゼント、思いをつたえるプレゼントとして
                      <br />
                      <br />
                      <div className=' pl-40 justify-center items-center'>
                      <Image src={'/image/flower-achway-2574849_1280.jpg'} alt='' height={400} width={400}  />
                      </div>
                      <br />
                  </div>
